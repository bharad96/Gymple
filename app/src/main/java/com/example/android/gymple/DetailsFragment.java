...
//public class DetailsFragment extends Fragment {
    ...
    public class FullDetail extends AppCompatActivity implements OnMapReadyCallback {
        ...
        private com.example.android.gymple.FullDetail.AddressResultReceiver mResultReceiver;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            mResultReceiver = new com.example.android.gymple.FullDetail.AddressResultReceiver(null);
            startIntentService();
            //endregion
            ...
            LinearLayoutManager horizontalLayoutManagaer = new LinearLayoutManager(com.example.android.gymple.FullDetail.this, LinearLayoutManager.HORIZONTAL, false);
            ...
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    try {
                        ...
                        pExampleAdapter = new PhotosAdapter(com.example.android.gymple.FullDetail.this, mPhotoList);
